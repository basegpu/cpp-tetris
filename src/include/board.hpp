...
public:
    ...
    Board();
    void AddTetrimino(const Tetrimino* tetrimino, const int& pRotation, const int& pX, const int& pY);
    bool IsPossibleMove(const Tetrimino* tetrimino, const int& pRotation, const int& pX, const int& pY);
...
protected:
    ...
    void LoopOverTetrimino(const Tetrimino* tetrimino, const int& pRotation, const int& pX, const int& pY, std::function<bool(const int&, const int&)> func);
