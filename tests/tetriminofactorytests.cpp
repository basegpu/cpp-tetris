...
protected:
	void SetUp() override
	{
		...
		rHook = Tetrimino::Make(Tetrimino::Type::RightHook);
		lHook = Tetrimino::Make(Tetrimino::Type::LeftHook);
		tee = Tetrimino::Make(Tetrimino::Type::Tee);
		rChair = Tetrimino::Make(Tetrimino::Type::RightChair);
		lChair = Tetrimino::Make(Tetrimino::Type::LeftChair);
	}
	...
	Tetrimino *square, *line, *rHook, *lHook, *tee, *rChair, *lChair;
};
